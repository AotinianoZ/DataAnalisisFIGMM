...
# Cuando usamos la conexión segura en localhost:

# con <- odbc::dbConnect(odbc(), Driver="MySQL Server",
...
# Otra forma:
# con<- odbc::dbConnect(odbc(), Driver="MySQL Server",
#                       Server="dallas166.arvixeshared.com",
#                       Database ="branextc_Peligro",
#                       uid= "branextc",
#                       pwd = "gdhB0a2X38",
#  
...
# mycon <- dbPool(RMySQL::MySQL(),
#                    dbname = "branextc_Peligro",
#                    host = "dallas166.arvixeshared.com",
#                    port = 2082,
#                    user = "branextc",
#                    password = "gdhB0a2X38")
...
df <- readxl::read_xlsx(path="SlidesR2/GQ_Colca_corregido2.xlsx", col_names = TRUE)
...
fviz_nbclust(kmedias, kmeans, method = "gapstat") #gapstat
